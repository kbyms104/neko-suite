# PowerShell Release Build Script for Neko Punch
$ErrorActionPreference = "Stop"

Write-Host "===================================================" -ForegroundColor Cyan
Write-Host "🐾 Neko Punch 릴리즈 배포 빌드를 시작합니다..." -ForegroundColor Cyan
Write-Host "===================================================" -ForegroundColor Cyan
...
$ReleaseExe = Join-Path $AppDir "src-tauri\target\release\neko-punch.exe"
...
if (Test-Path $ReleaseExe) {
    Copy-Item $ReleaseExe (Join-Path $PortableDir "Neko Punch.exe") -Force
    Copy-Item $ReleaseExe (Join-Path $WebDownloadsDir "Neko Punch.exe") -Force
}

$BundleDir = Join-Path $AppDir "src-tauri\target\release\bundle"
Write-Host "`n===================================================" -ForegroundColor Green
Write-Host "🎉 Neko Punch 릴리즈 배포 패키징이 완료되었습니다!" -ForegroundColor Green
Write-Host "포터블 파일: portable\Neko Punch.exe" -ForegroundColor Green
